...
const IconLeaf = ({ size = 48 }) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none">
    <path d="M12 22V12M12 12C12 7 7 4 2 5c0 5 3 9 10 7M12 12c0-5 5-8 10-7-1 5-4 9-10 7"
      stroke="#6BA876" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
  </svg>
);
...
const IconCamera = ({ size = 48 }) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none">
    <path d="M23 19a2 2 0 0 1-2 2H3a2 2 0 0 1-2-2V8a2 2 0 0 1 2-2h4l2-3h6l2 3h4a2 2 0 0 1 2 2z"
      stroke="#6BA876" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
    <circle cx="12" cy="13" r="4" stroke="#6BA876" strokeWidth="1.5"/>
  </svg>
);
...
export default function CropHealth() {
  ...
  return (
    <div style={{ minHeight: "100vh", background: "#F5FFFB", fontFamily: "'Inter', 'Geist', sans-serif" }}>
      ...
      <div className="mobile-pt-8 mobile-px-4" style={{ maxWidth: 760, margin: "0 auto", padding: "48px 24px 0" }}>
        ...
        <Link to="/" style={{
          ...
          color: "#4A8C5A", textDecoration: "none", fontSize: 13, marginBottom: 32,
        }}>
          <svg width="14" height="14" viewBox="0 0 24 24" fill="none">
        ...
        <h1 className="mobile-text-3xl" style={{ fontSize: 32, fontWeight: 600, color: "#1B4D2E", margin: "0 0 6px", letterSpacing: "-0.5px" }}>
          Crop Disease Detection
        </h1>
        <p style={{ color: "#4A8C5A", margin: "0 0 44px", fontSize: 15, lineHeight: 1.5 }}>
            ...
            {CROPS.map((c) => (
              <button key={c.id} onClick={() => setSelectedCrop(c.id)} 
                ...
                style={{
                  ...
                  border: `1px solid ${selectedCrop === c.id ? "#6BA876" : "#E8D5B0"}`,
                  background: selectedCrop === c.id ? "#6BA876" : "white",
                  color: selectedCrop === c.id ? "#fff" : "#2D6B44",
        ...
        <Section label="02" title="Provide a photo">
            ...
            {[
              ...
              <button key={id} onClick={() => handleModeSwitch(id)} 
                ...
                style={{
                  ...
                  background: mode === id ? "#1B4D2E" : "transparent",
                  color: mode === id ? "#F5FFFB" : "#4A8C5A",
                  fontWeight: 500, fontSize: 13, cursor: "pointer",
                }}>
          ...
          {mode === "upload" && !imagePreview && (
            <div
              ...
              onDrop={handleDrop}
              style={{
                border: `1.5px dashed ${dragOver ? "#6BA876" : "#D4B896"}`,
            ...
            >
              ...
              <p style={{ color: "#1B4D2E", fontWeight: 600, margin: "0 0 4px", fontSize: 15 }}>
                Drop your photo here
              </p>
              <p style={{ color: "#4A8C5A", fontSize: 13, margin: "0 0 20px" }}>
              ...
              <button
                ...
                style={{
                  ...
                  background: "#1B4D2E", color: "#D4EDD4",
            ...
            <div style={{ textAlign: "center" }}>
              {cameraActive ? (
                ...
                <div style={{
                  ...
                  <p style={{ color: "#1B4D2E", fontWeight: 600, margin: "0 0 16px", fontSize: 15 }}>
                    Use your device camera
                  </p>
                  <ActionBtn onClick={startCamera} primary>Open Camera</ActionBtn>
                  <p style={{ color: "#4A8C5A", fontSize: 12, marginTop: 14 }}>
                    or{" "}
                    <span
                      onClick={() => cameraInputRef.current?.click()}
                      style={{ color: "#6BA876", cursor: "pointer", textDecoration: "underline" }}
                    >
          ...
          {imagePreview && (
            <div style={{ textAlign: "center" }}>
              ...
              <p style={{ color: "#4A8C5A", fontSize: 12, marginTop: 8 }}>
        ...
        {imagePreview && !result && (
          <div style={{ textAlign: "center", margin: "8px 0 40px" }}>
            <button
              ...
              disabled={loading}
              style={{
                background: loading ? "#2D6B44" : "#1B4D2E",
                color: "#F5FFFB", border: "none", borderRadius: 999,
          ...
          <div id="diagnosis-results" style={{ marginBottom: 64 }}>
            <Section label="03" title="Diagnosis Results">
              ...
              <div style={{
                ...
                {statusIcon}
                <div>
                  <div style={{ fontWeight: 700, fontSize: 18, color: "#1B4D2E", marginBottom: 4 }}>
                    {result.disease_name}
                  </div>
                  <div style={{ color: "#4A8C5A", fontSize: 13 }}>
              ...
              <ResultCard icon={<IconNotes />} title="What we found">
                <p style={{ color: "#1B4D2E", lineHeight: 1.7, margin: 0, fontSize: 14 }}>{result.description}</p>
              </ResultCard>
                ...
                <ResultCard icon={<IconPill />} title="Treatment Steps">
                  <ol style={{ margin: 0, padding: "0 0 0 18px", display: "flex", flexDirection: "column", gap: 10 }}>
                    {result.treatment.map((step, i) => (
                      <li key={i} style={{ color: "#1B4D2E", lineHeight: 1.6, fontSize: 14 }}>
              ...
              {result.prevention && (
                <ResultCard icon={<IconShield />} title="Prevention Tip">
                  <p style={{ color: "#1B4D2E", lineHeight: 1.7, margin: 0, fontSize: 14 }}>{result.prevention}</p>
                </ResultCard>
              )}
  ...
  return (
    <div style={{ marginBottom: 36 }}>
      <div style={{ display: "flex", alignItems: "baseline", gap: 12, marginBottom: 16 }}>
        <span style={{ fontSize: 26, fontWeight: 700, color: "#A8D5A8" }}>{label}</span>
        <h2 style={{ fontSize: 18, fontWeight: 600, color: "#1B4D2E", margin: 0 }}>{title}</h2>
      </div>
      {children}
    </div>
  );
...
function ResultCard({ icon, title, children }) {
  return (
    <div style={{
      ...
      <div style={{
        display: "flex", alignItems: "center", gap: 7,
        fontWeight: 600, color: "#6BA876", marginBottom: 10, fontSize: 13,
      }}>
  ...
  return (
    <button onClick={onClick} 
      ...
      style={{
        ...
        background: primary ? "#1B4D2E" : "white",
        color:      primary ? "#F5FFFB" : "#1B4D2E",
...
function Spinner() {
  return (
    <span style={{
      ...
      borderTop: "2px solid #D4EDD4", borderRadius: "50%",

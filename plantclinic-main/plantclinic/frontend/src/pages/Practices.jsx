...
export default function Practices() {
  ...
  return (
    <div style={{ minHeight: "100vh", background: "#F5FFFB", fontFamily: "'Geist', sans-serif" }}>
      <style>{`
        @keyframes fadeUp {
        ...
        .crop-tab:hover { background: #D4EDD4 !important; }
        .section-pill:hover { background: #D4EDD4 !important; }
        .send-btn:hover { opacity: 0.88; }
        .chat-input:focus { outline: none; border-color: #6BA876 !important; }
      `}</style>
      ...
      <div className="page-container" style={{ maxWidth: 900, margin: "0 auto", padding: "110px 24px 0" }}>
        <Link to="/" style={{
          ...
          color: "#4A8C5A", textDecoration: "none", fontSize: 13, marginBottom: 24,
        }}>
          ← Back to home
        </Link>

        <h1 style={{ fontSize: "clamp(28px, 6vw, 36px)", fontWeight: 700, color: "#1B4D2E", margin: "0 0 8px", lineHeight: 1.2 }}>
          Farming Best Practices
        </h1>
        <p style={{ color: "#4A8C5A", margin: "0 0 32px", fontSize: "clamp(14px, 4vw, 16px)" }}>
          ...
          {CROPS.map((c) => (
            <button
              ...
              style={{
                ...
                color:       activeCrop.id === c.id ? "#fff"  : "#1B4D2E",
        ...
        >
          ...
          <div className="sidebar" style={{
            background: "#D4EDD4", borderRadius: 20,
            padding: 16, alignSelf: "start",
            position: "sticky", top: 100,
          }}>
            <div style={{
              fontSize: 11, fontWeight: 700, color: "#6BA876",
              ...
              {crop.sections.map((s, i) => (
                <button
                  ...
                  style={{
                    ...
                    color: activeSection === i ? "#1B4D2E" : "#4A8C5A",
            ...
            <div style={{
              ...
              fontSize: 12, color: "#4A8C5A", lineHeight: 1.5,
              fontStyle: "italic",
            }}>
              "{crop.tagline}"
            </div>
          ...
          <div className="content-card" key={`${activeCrop.id}-${activeSection}`} style={{
            ...
            <div style={{
              ...
              <div>
                ...
                <h2 style={{ fontSize: 18, fontWeight: 700, color: "#1B4D2E", margin: 0 }}>
                  {section.title}
                </h2>
              </div>
            </div>
            ...
            <div style={{ padding: "24px" }}>
              <p style={{
                color: "#1B4D2E", fontSize: 15, lineHeight: 1.8,
                margin: "0 0 24px",
              }}>
                {section.content}
              </p>
              ...
              <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", gap: 12 }}>
                <button
                  ...
                  style={{
                    ...
                    background: activeSection === 0 ? "transparent" : "#D4EDD4",
                    color: activeSection === 0 ? "#C9B090" : "#1B4D2E",
                ...
                <button
                  ...
                  style={{
                    flex: 1, padding: "10px 16px", borderRadius: 999,
                    border: "none",
                    background: activeSection === crop.sections.length - 1 ? "#E8D5B0" : "#1B4D2E",
                    color: activeSection === crop.sections.length - 1 ? "#9A7A5A" : "#F5FFFB",
        ...
        <div style={{
          ...
          {/* Chat header */}
          <div style={{
            background: "#1B4D2E", padding: "24px 28px",
            display: "flex", alignItems: "center", gap: 14,
          }}>
            <div style={{
              width: 44, height: 44, borderRadius: 12,
              background: "linear-gradient(135deg, #6BA876 0%, #A8D5A8 100%)",
              display: "flex", alignItems: "center", justifyContent: "center",
              boxShadow: "0 4px 12px rgba(186,117,23,.25)",
            }}>
              <svg width="22" height="22" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M12 2L14.8541 8.1459L21 11L14.8541 13.8541L12 20L9.1459 13.8541L3 11L9.1459 8.1459L12 2Z" fill="#F5FFFB" />
                <path d="M19 3L19.7123 4.2877L21 5L19.7123 5.7123L19 7L18.2877 5.7123L17 5L18.2877 4.2877L19 3Z" fill="#F5FFFB" opacity="0.6" />
              </svg>
            </div>
            <div>
              <div style={{ color: "#F5FFFB", fontWeight: 700, fontSize: 17, marginBottom: 2 }}>
                Ask Plant Clinic Advisor
              </div>
            ...
            {messages.length === 0 && (
              <div style={{ textAlign: "center", padding: "40px 0" }}>
                <div style={{ 
                  ...
                  background: "#D4EDD4", width: 80, height: 80, 
                  borderRadius: "50%", display: "flex", 
                  alignItems: "center", justifyContent: "center",
                  margin: "0 auto"
                }}>{crop.emoji}</div>
                <h3 style={{ color: "#1B4D2E", fontSize: 18, fontWeight: 700, margin: "0 0 8px" }}>
                  Need specific advice?
                </h3>
                <p style={{ color: "#4A8C5A", fontSize: 15, margin: "0 0 24px", lineHeight: 1.5 }}>
                  Ask Plant Clinic anything about growing {crop.label} —<br />
                ...
                <div style={{ display: "flex", gap: 8, justifyContent: "center", flexWrap: "wrap", marginTop: 16 }}>
                  {[
                    ...
                    <button key={q} onClick={() => setInput(q)} style={{
                      ...
                      border: "1px solid #E8D5B0", background: "#D4EDD4",
                      color: "#4A8C5A", fontSize: 13, cursor: "pointer",
                      transition: "all .15s ease",
                    }}>
                      {q}
                    </button>
            ...
            {messages.map((m, i) => (
              <div key={i} style={{
                ...
                <div style={{
                  ...
                  background: m.role === "user" ? "#1B4D2E" : "#D4EDD4",
                  color:      m.role === "user" ? "#F5FFFB" : "#1B4D2E",
                    ...
                    <ul style={{ margin: 0, padding: 0, listStyle: "none", display: "flex", flexDirection: "column", gap: 8 }}>
                      {m.content.map((point, j) => (
                        <li key={j} style={{ display: "flex", alignItems: "flex-start", gap: 8 }}>
                          <span style={{ marginTop: 4, width: 6, height: 6, borderRadius: "50%", background: "#6BA876", flexShrink: 0 }} />
                          <span>{point}</span>
                        </li>
                      ))}
                    </ul>
            ...
            {chatLoading && (
              <div style={{ display: "flex", justifyContent: "flex-start" }}>
                <div style={{
                  ...
                  background: "#D4EDD4", display: "flex", gap: 5, alignItems: "center",
                }}>
                  {[0, 1, 2].map((i) => (
                    <div key={i} style={{
                      width: 7, height: 7, borderRadius: "50%", background: "#6BA876",
          ...
          {/* Input area */}
          <div style={{
            borderTop: "1px solid #D4EDD4", padding: "16px 20px",
            display: "flex", gap: 10,
          }}>
            <input
              ...
              style={{
                ...
                border: "2px solid #E8D5B0", background: "#D4EDD433",
                color: "#1B4D2E", fontSize: 14,
            ...
            <button
              ...
              style={{
                ...
                background: chatLoading || !input.trim() ? "#E8D5B0" : "#1B4D2E",
                color: "#F5FFFB", border: "none", fontSize: 18,
